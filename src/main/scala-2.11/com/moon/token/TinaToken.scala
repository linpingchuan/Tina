...
/**
  ...
  */
case class TinaToken(input: String, tinaType: Int, var channel: Int = TinaToken.DEFAULT_CHANNEL, var start: Int, var stop: Int) {
  var text: String = _
  var line: Int = _
  ...
  def this(tt: Int) {
    this(null, tt, TinaToken.DEFAULT_CHANNEL, 0, 0)
  }
